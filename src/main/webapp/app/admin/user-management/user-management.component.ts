...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-jhipstersampleapplicationmonapp-alert'], {
          param: decodeURIComponent(res.headers['x-jhipstersampleapplicationmonapp-params'].replace(/\+/g, ' ')),
        });
