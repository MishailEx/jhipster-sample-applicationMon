...
@RestController
@RequestMapping("/api/jhipster-sample-application-mon-kafka")
public class JhipsterSampleApplicationMonKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationMonKafkaResource.class);
    ...
    public JhipsterSampleApplicationMonKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
